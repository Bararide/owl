...
private:
  ...
  std::map<std::string, std::shared_ptr<KnowledgeContainer<OssecContainerAdapter>>> containers_;
...
public:
  ...
  bool register_container(std::shared_ptr<KnowledgeContainer<OssecContainerAdapter>> container);
  ...
  std::vector<std::shared_ptr<KnowledgeContainer<OssecContainerAdapter>>> get_all_containers();
  std::vector<std::shared_ptr<KnowledgeContainer<OssecContainerAdapter>>>
  get_containers_by_owner(const std::string &owner);
  std::vector<std::shared_ptr<KnowledgeContainer<OssecContainerAdapter>>> get_available_containers();
  std::vector<std::shared_ptr<KnowledgeContainer<OssecContainerAdapter>>>
